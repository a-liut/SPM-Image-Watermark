...
#define EOS NULL
#define TIME_UNIT chrono::milliseconds
...
int main(int argc, char **argv)
{
    ...
    blocking_queue<iwm::Job *> *stage2_queue[degree];
    ...
    for(int i = 0; i < degree; i++)
    {
        ...
        stage1_workers[i] = new thread(stage1, stage1_queue[i], stage2_queue[i]);
