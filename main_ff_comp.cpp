...
#include "nodes_ff_comp/emitter.cpp"
#include "nodes_ff_comp/stage1.cpp"
#include "nodes_ff_comp/collector.cpp"
...
int main(int argc, char **argv)
{
    ...
    {
        W.push_back(make_unique<Stage1>(&stamp, &perf));
    }
